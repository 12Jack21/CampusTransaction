			...
			<view class="bg-white margin-top padding radius zaiui-trends">
				...
				<view class="cu-list menu-avatar">
					<view class="cu-item">
						...
						@tap="userTap('userTap', item, index)" />
						<view class="content" @tap="userTap('userTap', item, index)">
				...
				@tap="titleTap('titleTap', item, index)">
					<text>Title-{{ item.title }}</text>
				</view>

				<!--内容-->
				<view class="margin-tb text-black zaiui-text-content" 
				@tap="contentTap('contentTap', item, index)">
...
export default {
	...
	methods: {
		userTap(tap, data, index) {
			this.$emit('userTap', {
				data,
				index
			})
		},
		titleTap(tap, data, index) {
			this.$emit('titleTap', {
				data,
				index
			})
		},
		contentTap(tap, data, index) {

<template>
	<div class="show-box"  :class="{disabled: disabled, active: isShowList}" >
		<!-- 输入框，仅在可输入模式下使用 -->
		<input  
		...
		:style="'top:' + listTop__ + 'px;'" v-show="isShowList">
			...
			<scroll-view 
				class="list" style="background-color: #fff; border-radius: 10px;"  
...
<style scoped lang="less">
	...
	.show-box{
		...
		box-shadow: 0 0 29px 0 rgba(43,86,112,.1);
		color: #c1c1c1;
